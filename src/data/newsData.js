export const articles = [
  {
    ...
    subtitle: 'Друзья, коллеги и гости нашей Фабрики КОРУНД!',
    excerpt:
  ...
  },
  {
    ...
    subtitle: 'В результате лабораторных испытаний материалы серии «КОРУНД» получили высшую оценку.',
    excerpt:
      'В соответствии с новым европейским стандартом EN 16516 «Строительные продукты',
    body:
  ...
  },
  {
    id: '3',
    date: '16.10.2018',
    image: '/images/news/region.jpg',
    badge: '#регионы',
    title: 'КОРУНД в регионах',
    subtitle: 'Объективные причины отсутствия новостей',
  ...
  },
  {
    id: '4',
    date: '21.12.2017',
    image: '/images/news/germany-visit-2017.jpg',
    badge: '#вэд',
    title: 'Отчет о поездке в Германию',
    subtitle: 'Представители НПО "ФУЛЛЕРЕН" и "СИЛИЦИУМ" посетили международную специализированную архитектурно-строительную выставку «ARCHITECT AT WORK GERMANY 2017» (г. Дюссельдорф) и  ознакомились с новейшими строительными технологиями и оборудованием на рынке Европы.',
    excerpt:
      'В период с 06 по 10 декабря 2017 года представители научно-производственных объединений «ФУЛЛЕРЕН» и «СИЛИЦИУМ» приняли участие в международной бизнес-миссии экспортно-ориентированных субъектов малого и среднего предпринимательства Волгоградской области в Германию.',
    body:
      'В период с 06 по 10 декабря 2017 года представители научно-производственных объединений «ФУЛЛЕРЕН» и «СИЛИЦИУМ» приняли участие в международной бизнес-миссии экспортно-ориентированных субъектов малого и среднего предпринимательства Волгоградской области в Германию.\n' +
      '\n' +
  ...
  },
  {
    id: '5',
    date: '28.11.2017',
    image: '/images/news/jubilee-2017.jpg',
    badge: '#юбилей',
    title: 'Фабрике КОРУНД — 10 лет!',
    subtitle: 'Несмотря на небольшой возраст уже есть вполне конкретные успехи и достижения.',
    excerpt:
      'Нашей Фабрике КОРУНД уже 10 лет. Возраст ещё молодой, но за этот короткий срок мы уже достигли...',
  ...
  },
  {
    id: '6',
    date: '9.03.2017',
    image: '/images/news/korund-sweden.jpg',
    badge: '#вэд',
    title: 'Применение теплоизоляции КОРУНД в пригороде Стокгольма',
    subtitle: 'Перед специалистами компании «COLOTERM» (официальный дистрибьютор ООО «НПО ФУЛЛЕРЕН» в Швеции, директор Vladimir Goussakov) стояли следующие задачи: осуществить теплоизоляцию систем отопления и водоснабжения для уменьшения энергопотерь, а также предотвратить образование конденсата на трубопроводе холодного водоснабжения.',
  ...
  },
  {
    id: '7',
    date: '20.02.2017',
    image: '/images/news/samara-2017.jpg',
    badge: '#регионы',
    title: 'КОРУНД на международной выставке в Самаре',
    subtitle: '15–17.02.2017 г. в г. Самара прошла 23-я международная выставка-форум «Энергетика» где компания «СМА» принимала участие.',
    excerpt:
  ...
  },
  {
    id: '8',
    date: '12.01.2017',
    image: '/images/news/the-best-goods-2016.jpg',
    badge: '#достижения',
    title: 'Золотая медаль конкурса «Лучшие товары и услуги – ГЕММА»',
    subtitle: '26 декабря 2016 года в Большом зале Правительства Новосибирской области состоялась 15-ая юбилейная торжественная церемония награждения победителей Отборочного этапа Международного конкурса «Лучшие товары и услуги — ГЕММА».',
    excerpt:
      '26 декабря 2016 года в Большом зале Правительства Новосибирской области состоялась 15-ая юбилейная торжественная',
    body:
  ...
  },
  {
    id: '9',
    date: '12.08.2016',
    image: '/images/news/korund-sweden-2016.jpg',
    badge: '#вэд',
    title: 'КОРУНД в Швеции',
    subtitle: 'Наш представитель из Швеции - фирма Coloterm произвёл работы теплоизоляцией КОРУНД по предотвращению конденсата на трубопроводах в компрессорных системах охлаждения нескольких многоэтажных зданий.',
    excerpt:
      'Наш представитель из Швеции - фирма Coloterm произвёл работы теплоизоляцией КОРУНД...',
  ...
  },
  {
    id: '10',
    date: '24.02.2016',
    image: '/images/news/kavkazBuild-2016.jpg',
    badge: '#экспо',
    title: 'КОРУНД на выставке строительства и интерьера "KavkazBuild-2016"',
    subtitle: ' Выставку посетило свыше 4500 специалистов строительной отрасли, большая часть из которых представлена руководителями компаний.',
    excerpt:
  ...
  },
  {
    ...
    body:
      '17-19-02-2016, Россия, Ставрополь, СТАВРОПОЛЬЕ Южный ярмарочный комплекс.\n' +
      '\n' +
      'География участников была представлена не только Ставропольским краем, но и Москвой и Московской областью, Краснодарским краем, республиками Северного Кавказа, Волгоградской и Ростовской областями и многими другими регионами страны. Выставку посетило свыше 4500 специалистов строительной отрасли, большая часть из которых представлена руководителями компаний.\n' +
      '\n' +
      'Огромный интерес проявленный к КОРУНДУ стал основой для многочисленных новых контактов с представителями строительных, коммунальных и других компаний.',
  },
];
