...
export const products = [
  {
    ...
    fullDesc:
      'Используется при теплоизоляции крыш, фасадов зданий, внутренних стен, откосов окон, бетонного пола, трубопроводов горячего и холодного водоснабжения, паропроводов, воздуховодов систем кондиционирования, систем охлаждения, различных ёмкостей, цистерн, трейлеров, рефрижераторов. Применяется для исключения конденсата на трубах холодного водоснабжения и снижения теплопотерь в системах отопления (согласно СНиП).\n' +
    ...
    productDesc:
      'Сверхтонокое теплоизоляционное покрытие КОРУНД Классик — это инновационный  жидкий керамический многокомпонентный материал на основе полимерной системы, включающий закрытопороистые наполнители и предназначенный для нанесения на металлические поверхности.',
  ...
  },
  {
    ...
    fullDesc:
      'Обладает теплоизоляционными свойствами и повышенной паропроницаемостью. Предназначен для нанесения слоями до 1 мм на фасады зданий. Устраняет промерзания, образования конденсата и грибка. Эффективно снижает теплопотери, не нарушая естественный воздухообмен внутреннего помещения с окружающей средой. \n',
    productDesc:
      'КОРУНД Фасад создан специально для строительной сферы и применяется для теплоизоляции оштукатуренных, бетонных, кирпичных, деревянных и других поверхностей ограждающих конструкций зданий и сооружений.',
    packaging: 'Пластиковое ведро',
    volume: '5, 10 и 20 л',
    temperature: 'от -60°С до +200°С',
    color: 'Белый',
  ...
  },
  {
    ...
    fullDesc:
      'КОРУНД-Антикор наносится на плохо подготовленную металлическую поверхность со следами коррозии (ржавчины). Достаточно удалить металлической щёткой «сырую» (рыхлую) ржавчину, после чего можно наносить жидкую композицию КОРУНД-Антикор. \n' +
    ...
    productDesc:
      'Сверхтонкая теплоизоляция КОРУНД Антикор является уникальным высокоэффективным покрытием, способным при нанесении на плохо подготовленную металлическую поверхность преобразовывать ржавчину.',
    packaging: 'Пластиковое ведро',
    volume: '10 и 20 л',
    temperature: 'от -60°С до +200°С',
    color: 'Белый',
  ...
  },
  {
    ...
    fullDesc:
      'Данный материал разработан для применения в строительстве, реконструкции и ремонте жилых, коммерческих и общественных зданий. В отличие от других модификаций, работы по нанесению КОРУНД-Зима могут проводиться в интервале температур от -5 °С до -20 °С (минимальная температура нанесения обычных модификаций не ниже +7 °С). Температура эксплуатации модификации КОРУНД-Зима составляет от -60 °С до +90 °С. \n' +
      'С теплоизолятором КОРУНД-Зима вы забудете о перерывах в ожидании подходящей погоды. Срок службы материала от 15 лет. \n',
    productDesc:
      'КОРУНД Зима — это инновационный жидкий керамический многокомпонентный материал на основе специально подобранной полимерной системы, позволяющий проводить работы при отрицательных температурах.',
